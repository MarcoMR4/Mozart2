					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						echo '
							...
							<td>
								...
								<a href="editProducto.php?nik='.$row['idProducto'].'" title="Editar datos" class="btn btn-primary btn-sm">Modificar<span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
								<a href="productos.php?aksi=delete&nik='.$row['idProducto'].'" title="Eliminar" onclick="return confirm(\'Esta seguro de borrar los datos '.$row['nombre'].'?\')" class="btn btn-danger btn-sm">Eliminar<span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
						$no++;
